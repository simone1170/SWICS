 ...
 */
class SpectrumAnalyzer : public mmwave::MmWaveSpectrumPhy
{
  public:
    SpectrumAnalyzer();
     ...
     */
    void SetAntenna(Ptr<UniformPlanarArray> a);
  ...
  private:
    ...
    Ptr<UniformPlanarArray> m_antenna;    //!< Pointer to the Antenna model
