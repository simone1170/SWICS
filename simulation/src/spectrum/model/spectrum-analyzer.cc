...
void
SpectrumAnalyzer::SetAntenna(Ptr<UniformPlanarArray> a)
{
...
void 
SpectrumAnalyzer::SetTarget(Ptr<NetDevice> target)
{
    m_antenna->SetNumColumns(16);
    m_antenna->SetNumRows(16);
    
    ObjectFactory m_bfModelFactory = ObjectFactory ("ns3::MmWaveSvdBeamforming");
