...
SpectrumAnalyzerHelper::Install(NodeContainer c) const
{
    ...
    for (NodeContainer::Iterator i = c.Begin(); i != c.End(); ++i)
    {
        ...
        Ptr<UniformPlanarArray> antenna = Create<UniformPlanarArray>();
        antenna->SetAntennaElement(PointerValue(CreateObject<IsotropicAntennaModel>()));
        ...
        antenna->SetBeamformingVector(myVector);
